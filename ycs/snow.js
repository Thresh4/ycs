...
(function (e, t, n) {
    ...
    f.Util = {}, f.Util.log = function (t) {
        ...
        function i(e) {
            ...
            return i = function (e) {
                function t(e, r, i) {
                    var s = r.zIndex.zindex === "auto" ? 0 : Number(r.zIndex.zindex), o = e, u = r.zIndex.isPositioned, a = r.zIndex.isFloated, f = {node: r}, l = i;
...
Animation = function () {
    ...
    var o = [], u = 1, a = .1, f = 2, l = "http://p8.qhimg.com/d/inn/43158a81/Snowflakes.png", c = [], h = 5, p = 20, d = 20, v = {}, m = 1, g = 4, y = -1, b = 3, w = .2, E = 1.25, S = 2, x = 3, T = .2, N = .9, C = 50, k = 60, L = 0, A = 1, O = .1, M = 1.5, _ = .05, D, P, H, B, j, F, I;
    return {init: s}
